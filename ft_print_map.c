...
void 	ft_print_color2(t_env *e, int x, int y, int i, int j)
{
	(void)i;
	(void)j;
	if (e->map[i + 1][j])
...
void 	ft_print_segment2(t_env *e, int *pts1, int *pts2, int i, int j)
{
	int *v;
...
void	ft_print_segment_down(int i, int j, t_env *e)
{
	...
	ft_print_segment2(e, pts1, pts2, i, j);
}
